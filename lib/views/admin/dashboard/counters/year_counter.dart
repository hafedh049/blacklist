...
class _YearCounterState extends State<YearCounter> {
  ...
  Future<bool> _load() async {
    await FirebaseFirestore.instance.collection("sells").where("timestamp", isGreaterThanOrEqualTo: DateTime(DateTime.now().year)).get().then(
    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              formatDate(DateTime.now(), const <String>[yyyy]),
